...
I has extensive knowledge of libraries, archives, and linked data. I started a [MoMA Archives Linked Open Data Fellowship](https://www.wikidata.org/wiki/Wikidata:WikiProject_Museum_of_Modern_Art) in September, 2025. From 2013 to 2016, I worked as a [Wikipedian in Residence](https://en.wikipedia.org/wiki/Wikipedian_in_residence) at the [Metropolitan New York Library Council](http://metro.org/) and Assistant at the [Jean-Noël Herlin Archive Project](https://specificobject.com/projects/herlin/#.YH5B_txlA2w). I has [twelve years of Wikipedia editing and community organizing experience](https://en.wikipedia.org/wiki/User:Hexatekin). I am currently attending [Pratt Institute, School of Information](https://en.wikipedia.org/wiki/Pratt_Institute_School_of_Information) (Archives specialization).  

I has also worked as a grant writer, web designer, and teacher's assistant.  

I am also a cross-genre writer with publications that include experimental essays, poetry, short stories, and texts accompanying art exhibitions and music releases. I am the author of the chapbook *Troll* (Inpatient Press, 2015) and has published works in *Vol. 1 Brooklyn, Canadian Art, Rhizome, DIS, The New Inquiry, The Wikipedia Signpost* and more. I formerly produced and edited the [Arachne Webzine](http://arachnezine.com/), an experimental publishing project.  
